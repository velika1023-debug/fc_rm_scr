...
set PREVIOUS_STEP ${COMPILE_BLOCK_NAME}_initial_map
...
if { [lsearch $operations "INITIALIZE_FLOORPLAN"] >=0 } {
  ...
  rm_source -file $TCL_TRACK_CREATION_FILE -print "TCL_TRACK_CREATION_FILE" 
}
...
open_drc_error_data -file_name floorplan_rules_floorplan_init.err
attach_drc_error_data -name floorplan_rules_floorplan_init.err [get_drc_error_data floorplan_rules_floorplan_init.err]
sh rm -rf floorplan_rules_floorplan_init.err
...
if {[lsearch $operations "MACRO_PLACEMENT"] < 0} {
  ...
  open_drc_error_data -file_name floorplan_rules_macro.err
  attach_drc_error_data -name floorplan_rules_macro.err [get_drc_error_data floorplan_rules_macro.err]
  sh rm -rf floorplan_rules_macro.err
  if {$FIX_FLOORPLAN_RULES} {
	...
	open_drc_error_data -file_name floorplan_rules_macro_post_fix.err
	attach_drc_error_data -name floorplan_rules_macro_post_fix.err [get_drc_error_data floorplan_rules_macro_post_fix.err]
	sh rm -rf floorplan_rules_macro_post_fix.err
    }
  }
}
...
if { [lsearch $operations "MACRO_PLACEMENT"] >=0 } {
  ...
  if {[info exists CONGESTION_DRIVEN_PLACEMENT] && $CONGESTION_DRIVEN_PLACEMENT != ""} {
  ...
  if {[info exists TIMING_DRIVEN_PLACEMENT] && $TIMING_DRIVEN_PLACEMENT != ""} {
...
if { [lsearch $operations "BOUNDARY_CELL"] >=0 } {
  ...
  open_drc_error_data -file_name floorplan_rules_boundary_cell.err
  attach_drc_error_data -name floorplan_rules_boundary_cell.err [get_drc_error_data floorplan_rules_boundary_cell.err]
  sh rm -rf floorplan_rules_boundary_cell.err
}
...
if { [lsearch $operations "TAP_CELL"] >=0 } {
  ...
  open_drc_error_data -file_name floorplan_rules_tap_cell.err
  attach_drc_error_data -name floorplan_rules_tap_cell.err [get_drc_error_data floorplan_rules_tap_cell.err]
  sh rm -rf floorplan_rules_tap_cell.err
}
...
if { [lsearch $operations "NODE_SUPPLEMENT"] >=0 } {
  ...
  open_drc_error_data -file_name floorplan_rules_node_supplement.err
  attach_drc_error_data -name floorplan_rules_node_supplement.err [get_drc_error_data floorplan_rules_node_supplement.err]
  sh rm -rf floorplan_rules_node_supplement.err
}
...
if { [lsearch $operations "PNS"] >=0 } {
  ...
  rm_source -file $TCL_COMPILE_PG_FILE -print "TCL_COMPILE_PG_FILE"
