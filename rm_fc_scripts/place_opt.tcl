...
set set_qor_strategy_cmd "set_qor_strategy -stage place_initial -metric \"${SET_QOR_STRATEGY_METRIC}\" -mode \"${SET_QOR_STRATEGY_MODE}\""
...
if {([check_license -quiet "Fusion-Compiler-BE-NX"] || [check_license -quiet "Fusion-Compiler-NX"]) && [llength $TCL_PRIMEPOWER_CONFIG_FILE]> 0  && [lsearch $INDESIGN_PRIMEPOWER_STAGES "AFTER_PLACE_OPT"] >= 0} {
        ...
        if {$KEEP_INDESIGN_SAIF_FILE} {lappend update_indesign_cmd -keep saif -saif_suffix place_opt}
