...
rm_source -file $SIDEFILE_FUNCTIONAL_ECO_1 -optional -print "SIDEFILE_FUNCTIONAL_ECO_1"
...
if {$HPC_CORE != ""} {rm_source -file ${HPC_PLUGINS_DIR}/functional_eco_pre_script.tcl -optional -print "HPC_FUNCTIONAL_ECO_PRE_SCRIPT"; set CURRENT_PLUGIN_STEP "functional_eco_pre"; source $HPC_USER_OVERRIDES_SCRIPT}
...
########################################
if {([sizeof_collection [get_cells -hier -quiet xofiller!${CHIP_FINISH_METAL_FILLER_PREFIX}*]] > 0) && ($FUNCTIONAL_ECO_MODE!="freeze_silicon")} {

  if {[file exists [which $SIDEFILE_FUNCTIONAL_ECO_2]]} {
    puts "RM-info: Filler cells were detected in the source design.  Performing refill..."
	  rm_source -file $SIDEFILE_FUNCTIONAL_ECO_2 -optional -print "SIDEFILE_FUNCTIONAL_ECO_2"
  } else {
...
if {!([compare_collections [get_shapes -hier -quiet] [get_shapes -hier -include_fill -quiet]]=="0")} {
	...
	rm_source -file $SIDEFILE_FUNCTIONAL_ECO_3 -optional -print "SIDEFILE_FUNCTIONAL_ECO_3"
...
if {$HPC_CORE != ""} {
  rm_source -file ${HPC_PLUGINS_DIR}/functional_eco_post_script.tcl -optional -print "HPC_FUNCTIONAL_ECO_POST_SCRIPT"; set CURRENT_PLUGIN_STEP "functional_eco_post"; source $HPC_USER_OVERRIDES_SCRIPT
