...
if {$HPC_CORE != ""} {rm_source -file ${HPC_PLUGINS_DIR}/icv_in_design_pre_script.tcl -optional -print "HPC_ICV_IN_DESIGN_PRE_SCRIPT"; set CURRENT_PLUGIN_STEP "icv_in_design_pre"; source $HPC_USER_OVERRIDES_SCRIPT}
...
if {$ICV_IN_DESIGN_METAL_FILL} {
	...
	if {$SIDEFILE_ICV_IN_DESIGN_CUSTOM_METAL_FILL != "" } {
		rm_source -file $SIDEFILE_ICV_IN_DESIGN_CUSTOM_METAL_FILL -print "SIDEFILE_ICV_IN_DESIGN_CUSTOM_METAL_FILL"
		if {$ICV_IN_DESIGN_DRC} {
			...
			eval $signoff_check_drc_cmd -error_data POST_MFILL
...
if {$HPC_CORE != ""} {
  rm_source -file ${HPC_PLUGINS_DIR}/icv_in_design_post_script.tcl -optional -print "HPC_ICV_IN_DESIGN_POST_SCRIPT"; set CURRENT_PLUGIN_STEP "icv_in_design_post"; source $HPC_USER_OVERRIDES_SCRIPT
