...
if {$HPC_CORE != ""} {rm_source -file ${HPC_PLUGINS_DIR}/chip_finish_pre_script.tcl -optional -print "HPC_CHIP_FINISH_PRE_SCRIPT"; set CURRENT_PLUGIN_STEP "chip_finish_pre"; source $HPC_USER_OVERRIDES_SCRIPT}
...
if {$HPC_CORE != ""} {
  rm_source -file ${HPC_PLUGINS_DIR}/chip_finish_post_script.tcl -optional -print "HPC_CHIP_FINISH_POST_SCRIPT"; set CURRENT_PLUGIN_STEP "chip_finish_post"; source $HPC_USER_OVERRIDES_SCRIPT
