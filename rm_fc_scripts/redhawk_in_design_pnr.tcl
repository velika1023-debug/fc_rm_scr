...
if {$HPC_CORE != ""} {rm_source -file ${HPC_PLUGINS_DIR}/redhawk_in_design_pre_script.tcl -optional -print "HPC_REDHAWK_IN_DESIGN_PRE_SCRIPT"; set CURRENT_PLUGIN_STEP "redhawk_in_design_pre"; source $HPC_USER_OVERRIDES_SCRIPT}
...
if {$HPC_CORE != ""} {
  rm_source -file ${HPC_PLUGINS_DIR}/redhawk_in_design_post_script.tcl -optional -print "HPC_REDHAWK_IN_DESIGN_POST_SCRIPT"; set CURRENT_PLUGIN_STEP "redhawk_in_design_post"; source $HPC_USER_OVERRIDES_SCRIPT
