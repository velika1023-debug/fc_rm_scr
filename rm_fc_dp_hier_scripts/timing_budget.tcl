...
if {$HPC_CORE != ""} {rm_source -file ${HPC_PLUGINS_DIR}/budget_setup.tcl -optional -print "HPC_BUDGETING_SETUP_FILE"}
...
if {$HPC_CORE != ""} {rm_source -file ${HPC_PLUGINS_DIR}/boundary_budget_constraints_file.tcl -optional -print "HPC_BOUNDARY_BUDGETING_CONSTRAINTS_FILE"}
