...
if {$PLACEMENT_STYLE=="on_edge"} {
  ...
  if { $fp_status == "block_pin_placement" } {
    ...
    set terms_removing [get_terminals -of_objects [get_cells $SUB_BLOCK_INSTS] -filter "physical_status==unrestricted"]
...
set_attribute -quiet [get_cells $SUB_BLOCK_INSTS] physical_status fixed
