...
if {$HPC_CORE != ""} {rm_source -file ${HPC_PLUGINS_DIR}/place_pins_pre_script.tcl -optional -print "HPC_PLACE_PINS_PRE_SCRIPT"}
...
if {$HPC_CORE != ""} {rm_source -file ${HPC_PLUGINS_DIR}/place_pins_post_script.tcl -optional -print "HPC_PLACE_PINS_POST_SCRIPT"}
